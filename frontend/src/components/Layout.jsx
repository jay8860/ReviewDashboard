...
import {
    ...
    Sun, Moon, Menu, ChevronRight, Users, X, CheckSquare, Map, ShieldCheck, BarChart3, FileStack
} from 'lucide-react';
...
const Layout = ({ children, user, onLogout }) => {
    ...
    const menuItems = [
        ...
        { icon: FileStack, label: 'General Info', path: '/general-info', desc: 'District brief & references', module: 'general_info' },
